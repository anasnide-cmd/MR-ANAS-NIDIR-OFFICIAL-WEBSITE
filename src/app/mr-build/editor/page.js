...
function MrBuildEditorContent() {
    ...
    const templates = [
        ...
        },
        {
            ...
            name: 'Modern Store',
            icon: '🛍️',
            desc: 'Complete e-commerce storefront design.',
            html: '<nav class="store-nav">\n  <div class="brand">LuxeStore</div>\n  <div class="cart-icon">🛒 <span class="badge">2</span></div>\n</nav>\n<header class="store-hero">\n  <div class="hero-content">\n    <h1>Summer Collection 2025</h1>\n    <p>Discover the new trends.</p>\n    <button class="shop-btn">Shop Now</button>\n  </div>\n</header>\n<section class="products">\n  <h2>New Arrivals</h2>\n  <div class="product-grid">\n    <div class="product-card">\n      <div class="p-img" style="background-color: #333;"></div>\n      <div class="p-info">\n        <h4>Premium Watch</h4>\n        <p class="price">$199.00</p>\n        <button class="add-btn">Add to Cart</button>\n      </div>\n    </div>\n    <div class="product-card">\n      <div class="p-img" style="background-color: #444;"></div>\n      <div class="p-info">\n        <h4>Leather Bag</h4>\n        <p class="price">$149.00</p>\n        <button class="add-btn">Add to Cart</button>\n      </div>\n    </div>\n    <div class="product-card">\n      <div class="p-img" style="background-color: #555;"></div>\n      <div class="p-info">\n        <h4>Sunglasses</h4>\n        <p class="price">$89.00</p>\n        <button class="add-btn">Add to Cart</button>\n      </div>\n    </div>\n  </div>\n</section>',
            css: 'body { margin: 0; font-family: "Inter", sans-serif; background: #fff; color: #000; }\n.store-nav { display: flex; justify-content: space-between; align-items: center; padding: 20px 5%; border-bottom: 1px solid #eee; }\n.brand { font-weight: 900; font-size: 1.5rem; letter-spacing: -1px; }\n.badge { background: #000; color: #fff; padding: 2px 6px; border-radius: 10px; font-size: 0.7rem; vertical-align: top; }\n.store-hero { height: 60vh; background: #f4f4f4; display: flex; align-items: center; justify-content: center; text-align: center; }\n.store-hero h1 { font-size: 3.5rem; margin: 0 0 20px; }\n.shop-btn { padding: 15px 40px; background: #000; color: #fff; border: none; font-size: 1rem; cursor: pointer; transition: transform 0.2s; }\n.shop-btn:hover { transform: scale(1.05); }\n.products { padding: 80px 5%; }\n.products h2 { text-align: center; margin-bottom: 50px; font-size: 2rem; }\n.product-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px; }\n.product-card { transition: all 0.3s; }\n.product-card:hover { transform: translateY(-5px); }\n.p-img { height: 300px; background-color: #eee; margin-bottom: 20px; }\n.p-info { text-align: center; }\nh4 { margin: 10px 0; font-size: 1.1rem; }\n.price { font-weight: bold; color: #666; margin-bottom: 15px; }\n.add-btn { width: 100%; padding: 10px; background: transparent; border: 1px solid #000; cursor: pointer; transition: all 0.2s; }\n.add-btn:hover { background: #000; color: #fff; }'
        },
        {
            id: 'saas',
            name: 'SaaS Startup',
