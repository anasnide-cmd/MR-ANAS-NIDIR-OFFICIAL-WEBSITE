    ...
    return (
        <div className="login-wrapper">
            ...
            <style jsx>{`
                ...
                .login-header h1 { font-family: var(--font-orbitron); font-size: 1.8rem; margin-bottom: 10px; color: #fff; letter-spacing: 1px; }
                .login-header p { font-size: 0.9rem; opacity: 0.6; margin-bottom: 30px; line-height: 1.5; }
                ...
                .auth-form input:focus { border-color: #00f0ff; outline: none; background: rgba(0, 240, 255, 0.05); box-shadow: 0 0 15px rgba(0, 240, 255, 0.15); }
                ...
                .btn-primary:hover { box-shadow: 0 0 25px rgba(0, 240, 255, 0.4); transform: translateY(-1px); }
                ...
                @media (max-width: 768px) {
                    .login-wrapper { height: auto; min-height: 100dvh; padding: 15px; }
                    .login-card { padding: 30px 20px; border-radius: 20px; }
                    .shield-icon { font-size: 2.5rem; margin-bottom: 15px; }
                    .login-header h1 { font-size: 1.5rem; }
                    .login-header p { font-size: 0.85rem; margin-bottom: 24px; }
