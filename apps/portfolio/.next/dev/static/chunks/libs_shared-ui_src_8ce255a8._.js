...
"[project]/libs/shared-ui/src/Savoirpedia/GalaxyView.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GalaxyView({ articles, onClose }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GalaxyView.useEffect": ()=>{
            if (!canvasRef.current) return;
            const canvas = canvasRef.current;
            const ctx = canvas.getContext('2d');
            let animationFrame;
            const resize = {
                "GalaxyView.useEffect.resize": ()=>{
            ...
            const nodes = articles.map({
                "GalaxyView.useEffect.nodes": (art, idx)=>({
                        ...art,
            ...
            }["GalaxyView.useEffect.nodes"]);
            // 2. Map Connections (based on categories for now)
            const connections = [];
            nodes.forEach({
                "GalaxyView.useEffect": (node, i)=>{
                    nodes.forEach({
                        "GalaxyView.useEffect": (other, j)=>{
            ...
            const draw = {
                "GalaxyView.useEffect.draw": ()=>{
                    ...
                    // Update & Draw Nodes
                    nodes.forEach({
                        "GalaxyView.useEffect.draw": (node)=>{
                            node.x += node.vx;
                            node.y += node.vy;
                            // Wall Bounce
            ...
            draw();
            const handleClick = {
                "GalaxyView.useEffect.handleClick": (e)=>{
                    const rect = canvas.getBoundingClientRect();
                    const mouseX = e.clientX - rect.left;
                    const mouseY = e.clientY - rect.top;
                    nodes.forEach({
                        "GalaxyView.useEffect.handleClick": (node)=>{
                    ...
                    }["GalaxyView.useEffect.handleClick"]);
                }
            }["GalaxyView.useEffect.handleClick"];
...
_s(GalaxyView, "gDgxcWlukmMX77JOVCTl4+KWwU8=", false, function() {
    return [
...
_c = GalaxyView;
var _c;
__turbopack_context__.k.register(_c, "GalaxyView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/libs/shared-ui/src/Savoirpedia/HubClient.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$libs$2f$shared$2d$ui$2f$src$2f$Savoirpedia$2f$GalaxyView$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/libs/shared-ui/src/Savoirpedia/GalaxyView.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function HubClient() {
    ...
    const [showGalaxy, setShowGalaxy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HubClient.useEffect": ()=>{
            const fetchPosts = {
                "HubClient.useEffect.fetchPosts": async ()=>{
                    try {
                        const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$libs$2f$core$2f$src$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'posts'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('date', 'desc'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["limit"])(50));
                        ...
                        const data = snap.docs.map({
                            "HubClient.useEffect.fetchPosts.data": (d)=>({
                                    id: d.id,
                                    ...d.data()
                                })
                        }["HubClient.useEffect.fetchPosts.data"]);
                        setPosts(data);
            ...
            }["HubClient.useEffect.fetchPosts"];
            fetchPosts();
        }
    }["HubClient.useEffect"], []);
        ...
        "HubClient.useEffect": ()=>{
            ...
            if (searchTerm) {
                results = results.filter({
                    "HubClient.useEffect": (post)=>post.title.toLowerCase().includes(searchTerm.toLowerCase()) || post.content.toLowerCase().includes(searchTerm.toLowerCase())
                }["HubClient.useEffect"]);
            }
            // 2. Category Filter
            if (activeCategory !== 'All') {
                results = results.filter({
                    "HubClient.useEffect": (post)=>(post.category || 'General') === activeCategory
                }["HubClient.useEffect"]);
            }
            // 3. Status Filter (Legacy vs Active)
            results = results.filter({
                "HubClient.useEffect": (post)=>post.status === 'active' || !post.status
            }["HubClient.useEffect"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            showGalaxy && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$libs$2f$shared$2d$ui$2f$src$2f$Savoirpedia$2f$GalaxyView$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                articles: posts,
...
_s(HubClient, "6nEzUEMC5xbWeLAZK2WWKHnBjuA=");
_c = HubClient;
var _c;
__turbopack_context__.k.register(_c, "HubClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=libs_shared-ui_src_8ce255a8._.js.map
